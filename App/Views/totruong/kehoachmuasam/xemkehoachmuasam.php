...
<div class="container d-flex justify-content-center align-items-center mb-5">
    <div class="card-na border-0" style="max-width: 46rem; width: 100%;">
        <div class="card-body p-4">
            <h3 class="text-center mb-4 fw-bold text-primary">Chi tiết kế hoạch mua sắm</h3>
            <!-- Họ tên -->
            <div class="mb-3">
            ...
            <!-- Tổng chi phí -->
            <div class="mb-3">
                <label class="form-label fw-medium">Tổng chi phí</label>
                <input type="text" class="form-control" value="<?php echo number_format($r['tongChiPhi'], 0, ',', '.') . ' ₫'; ?>" disabled>
            </div>
