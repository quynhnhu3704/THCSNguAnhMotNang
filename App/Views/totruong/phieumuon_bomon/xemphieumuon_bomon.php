<!-- App/Views/totruong/phieumuon_bomon/xemphieumuon_bomon.php -->
<?php
...
if(!$maPhieuMuon) {
    echo "<script>alert('Không tìm thấy phiếu mượn.'); window.location.href='index.php?page=dsphieumuon_bomon';</script>";
    exit();
}
...
<div class="container d-flex justify-content-center align-items-center mb-5">
    <div class="card-na border-0" style="max-width: 56rem; width: 100%;">
        <div class="card-body p-5">
            ...
            <!-- Tiêu đề đơn -->
            <h4 class="text-center fw-bold text-primary text-uppercase mb-4">Phiếu mượn thiết bị dạy học</h4>
