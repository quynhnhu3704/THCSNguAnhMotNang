<!-- App/Views/admin/qlnguoidung/dsnguoidung.php -->
<?php
    ...
    <div class="table-responsive my-5" style="width: 95%;">
        <table class="table table-striped table-hover table-borderless align-middle" style="font-size: 0.85em;">
            ...
            if ($kq && $kq->num_rows > 0) {
                ...
                echo '<tr><td colspan="8"><h5 class="text-center text-muted">Chúng tôi tạm thời chưa có người dùng nào, mời bạn quay lại sau.</h5></td></tr>';   
            }
            ?>
            </tbody>
        </table>
