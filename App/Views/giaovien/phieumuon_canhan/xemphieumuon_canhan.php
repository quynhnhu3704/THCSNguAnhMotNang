<!-- App/Views/giaovien/phieumuon_canhan/xemphieumuon_canhan.php -->
<?php
...
<div class="d-flex justify-content-between align-items-center mx-4 my-4">
    ...
    <button type="button" id="exportPDF" class="btn btn-dark"><i class="bi bi-printer"></i> In phiếu mượn</button>
</div>
