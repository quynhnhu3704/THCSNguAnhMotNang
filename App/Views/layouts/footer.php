        ...
        <div class="row g-4">
            ...
            <!-- <div class="col-6 col-lg-2">
                ...
                <ul class="list-unstyled">
                    <li><a class="footer-link text-decoration-none" href="index.php#rooms">Phòng</a></li>
                    <li><a class="footer-link text-decoration-none" href="index.php#amenities">Tiện nghi</a></li>
                    <li><a class="footer-link text-decoration-none" href="index.php#gallery">Ảnh</a></li>
                </ul>
            </div> -->
            ...
            <div class="col-lg-3">
                ...
                <div class="small opacity-75 mt-3">© 2025 THCS Ngũ Anh Một Nàng</div>
            </div>
        </div>
    </div>
</footer>