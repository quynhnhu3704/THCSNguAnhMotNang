<!-- App/Views/thietbi/kehoachthanhly/xemkehoachthanhly.php -->
<?php
...
<div class="d-flex justify-content-between align-items-center mx-4 my-4">
    ...
    <button type="button" id="exportPDF" class="btn btn-outline-secondary"><i class="bi bi-printer"></i> Xuất PDF</button>
</div>
