            ...
            if ($kq && $kq->num_rows > 0) {
                ...
                while ($r = $kq->fetch_assoc()) {
                    ...
                    echo '<tr>';
                        ...
                        echo '<td class="text-center">';
                            echo '<a href="index.php?page=ghinhanthietbi&maChiTietTB=' . $r['maChiTietTB'] . '" class="btn btn-sm btn-warning" style="font-size: 0.95em;"><i class="bi bi-pencil-square"></i> Ghi nhận</a>&nbsp;';
                        echo '</td>';
                    echo '</tr>';
                }
            } else {
