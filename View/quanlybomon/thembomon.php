        ...
        <div class="card-body p-4">
            ...
            <form action="#" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="tenBoMon" value="" class="form-control" required>
                </div>
    ...
    if(isset($_POST['btnluu'])) {
        ...
        if($p->checkName($tenBoMon)) {
            ...
            if($p->insertBoMon($tenBoMon, $moTa)) {
                echo '<script>alert("Thêm thành công!"); window.location.href="index.php?page=quanlybomon";</script>';
            } else {
