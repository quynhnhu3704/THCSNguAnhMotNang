...
<button type="button" class="btn btn-outline-primary ms-4 my-4" onclick="window.location.href='index.php?page=quanlynguoidung'"><i class="bi bi-arrow-left"></i> Quay lại</button>
        ...
        <div class="card-body p-4">
            ...
            <form action="#" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="tenDangNhap" value="" class="form-control" required>
                </div>
                
                <!-- Mật khẩu tạm thời -->
                <div class="mb-3">
                    <label class="form-label fw-medium">Mật khẩu tạm thời <span class="text-danger">*</span></label>
                    <input type="password" name="matKhauTamThoi" value="" class="form-control" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="tel" name="soDienThoai" value="" class="form-control" required>
                </div>
    ...
    if(isset($_POST['btnluu'])) {
        ...
        if($p->checkName($tenDangNhap)) {
            ...
            if($p->insertNguoiDung($tenDangNhap, $hoTen, $matKhauTamThoi, $soDienThoai, $email, $maVaiTro, $maBoMon)) {
                echo '<script>alert("Thêm thành công!"); window.location.href="index.php?page=quanlynguoidung";</script>';
            } else {
