...
<button type="button" class="btn btn-outline-primary ms-4 my-4" onclick="window.location.href='index.php?page=quanlynhacungcap'"><i class="bi bi-arrow-left"></i> Quay lại</button>
        ...
        <div class="card-body p-4">
            ...
            <form action="#" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="tenNhaCungCap" value="" class="form-control" required>
                </div>

                <!-- Địa chỉ -->
                <div class="mb-3">
                    <label class="form-label fw-medium">Địa chỉ <span class="text-danger">*</span></label>
                    <input type="text" name="diaChi" value="" class="form-control" required>
                </div>
    ...
    if(isset($_POST['btnluu'])) {
        ...
        if($p->checkName($tenNhaCungCap)) {
            ...
            if($p->insertNhaCungCap($tenNhaCungCap, $diaChi, $soDienThoai, $email)) {
                echo '<script>alert("Thêm thành công!"); window.location.href="index.php?page=quanlynhacungcap";</script>';
            } else {
