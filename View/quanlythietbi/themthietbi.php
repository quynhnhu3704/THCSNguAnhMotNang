...
<button type="button" class="btn btn-outline-primary ms-4 my-4" onclick="window.location.href='index.php?page=quanlythietbi'"><i class="bi bi-arrow-left"></i> Quay lại</button>
        ...
        <div class="card-body p-4">
            ...
            <form action="#" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="tenThietBi" value="" class="form-control" required>
                </div>
        ...
        if($p->checkName($tenThietBi)) {
            ...
            if($hinh) {
                if($p->insertThietBi($tenThietBi, $hinh, $donVi, $soLuong, $lop, $maBoMon, $maNhaCungCap, $tinhTrang, $ghiChu)) {
                    echo '<script>alert("Thêm thành công!"); window.location.href="index.php?page=quanlythietbi";</script>';
                } else {
