...
<div class="d-flex mx-auto justify-content-between align-items-center" style="width: 95%">
    ...
    <form class="d-flex" action="index.php" method="get">
        <input type="hidden" name="page" value="quanlybomon"> <!-- Submit sẽ tạo URL: index.php?page=quanlybomon&keyword=xxxxx -->
        ...
        <table class="table table-striped table-hover table-borderless align-middle" style="font-size: 0.85em;">
            ...
            <?php
                ...
                if ($kq && $kq->num_rows > 0) {
                    ...
                    echo '<tr><td colspan="11"><h3 class="text-muted">Chúng tôi tạm thời chưa có bộ môn nào, mời bạn quay lại sau.</h3></td></tr>';   
                }
            ?>
            </tbody>
        </table>
